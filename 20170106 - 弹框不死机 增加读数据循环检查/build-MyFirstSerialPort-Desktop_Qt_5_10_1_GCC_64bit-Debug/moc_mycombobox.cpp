...
#include "../MyFirstSerialPort/mycombobox.h"
...
void mycombobox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (mycombobox::*_t)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mycombobox::clicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void mycombobox::clicked(bool _t1)
{
