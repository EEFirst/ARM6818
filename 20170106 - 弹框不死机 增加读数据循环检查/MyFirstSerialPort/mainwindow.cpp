...
void MainWindow::uiBaseInit()
{
   ...
   // sendButton = new QPushButton(ui->Base_2);
    ui->sendButton->setText("发送");
//   ui->sendButton->setGeometry(20,365,100,30);
...
//    clearButton->setGeometry(120,365,100,30);
    ...
    connect(ui->sendButton,SIGNAL(clicked(bool)),this,SLOT(sendFunction()));
...
//    ui->timerEdit->setText("20");
    ...
    ui->zidongfasong->setEnabled(false);
}
...
//        ui->timerStop->setEnabled(false);
        ui->zidongfasong->setEnabled(true);
    }else{
